...
const generateCharacters = () => {
  const rarities = [
    { key: 'Common', prefix: 'common', count: 99, hp: 1440, atk: 28, def: 5, spd: 10, imageColor: '#7f8c8d' },
    { key: 'Rare', prefix: 'rare', count: 79, hp: 4320, atk: 64, def: 15, spd: 30, imageColor: '#3498db' },
    { key: 'SR', prefix: 'super_rare', count: 60, hp: 7200, atk: 235, def: 30, spd: 55, imageColor: '#2ecc71' },
    { key: 'Epic', prefix: 'epic', count: 40, hp: 10080, atk: 455, def: 50, spd: 85, imageColor: '#9b59b6' },
    { key: 'Legendary', prefix: 'legendary', count: 20, hp: 21600, atk: 1200, def: 120, spd: 180, imageColor: '#2c003e' }
  ];
